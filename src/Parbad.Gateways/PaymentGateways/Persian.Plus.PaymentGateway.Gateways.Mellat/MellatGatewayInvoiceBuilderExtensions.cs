...
namespace Persian.Plus.PaymentGateway.Gateways.Mellat
{
    public static class MellatGatewayInvoiceBuilderExtensions
    {
        ...
        public static IInvoiceBuilder AddMellatCumulativeAccount(this IInvoiceBuilder builder, long subServiceId,
            long amount)
        {
        ...
        public static IInvoiceBuilder AddMellatCumulativeAccounts(this IInvoiceBuilder builder,
            IEnumerable<MellatCumulativeDynamicAccount> accounts)
        {
