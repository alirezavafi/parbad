...
namespace Persian.Plus.PaymentGateway.Core.Invoice
{
    ...
    public static class InvoiceBuilderExtensions
    {
        ...
        public static IInvoiceBuilder AddFormatter(this IInvoiceBuilder builder, Action<Gateway.Invoice> formatInvoice)
        {
            if (builder == null) throw new ArgumentNullException(nameof(builder));
        ...
        /// <param name="builder"></param>
        /// <param name="formatInvoice"></param>
        public static IInvoiceBuilder AddFormatter(this IInvoiceBuilder builder, Func<Gateway.Invoice, Task> formatInvoice)
        {
            if (builder == null) throw new ArgumentNullException(nameof(builder));
