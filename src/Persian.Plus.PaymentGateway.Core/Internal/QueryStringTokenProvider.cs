...
namespace Persian.Plus.PaymentGateway.Core.Internal
{
    public abstract class QueryStringTokenProvider : IPaymentTokenProvider
    {
        ...
        public virtual async Task<string> ProvideTokenAsync(Gateway.Invoice invoice, CancellationToken cancellationToken = default)
        {
        ...
        protected abstract Task<string> GenerateTokenAsync(Gateway.Invoice invoice, CancellationToken cancellationToken = default);
